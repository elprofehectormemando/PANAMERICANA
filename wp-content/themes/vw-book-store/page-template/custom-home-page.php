              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <?php if( get_theme_mod('vw_book_store_slider_content_hide_show',true) != ''){ ?>
                    <p class="wow zoomInDown delay-1000" data-wow-duration="2s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_book_store_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_book_store_slider_excerpt_number','30')))); ?></p>
                  <?php } ?>
