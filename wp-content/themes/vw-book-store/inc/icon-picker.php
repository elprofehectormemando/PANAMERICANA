        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-book-store' ); ?>">
                </div>
...
function vw_book_store_customizer_script() {
    ...
    wp_enqueue_script( 'vw-book-store-customizer-script', esc_url(get_template_directory_uri()).'/js/customizer-scripts.js', array("jquery"),'', true  );
}
